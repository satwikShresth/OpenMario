...
import {
  ...
  IconButton, Typography, Box, Backdrop, Fade,
  Grid2 as Grid, TextField, Tooltip, Stepper, Step, StepLabel, StepContent,
  Paper
} from '@mui/material';
import {
  Upload, X, ImagePlus, FileUp, Clipboard,
  ExternalLink, ChevronRight, ArrowLeft, ArrowRight,
  CheckCircle
} from 'lucide-react';
