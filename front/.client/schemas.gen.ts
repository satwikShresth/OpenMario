...
export const SubmissionAggregateSchema = {
    ...
    required: ['company', 'position', 'location', 'work_hours', 'compensation', 'other_compensation', 'details', 'year', 'coop_year', 'coop_cycle', 'program_level']
} as const;
...
export const SubmissionAggregateUpdateSchema = {
    ...
    required: ['company', 'position', 'location', 'work_hours', 'compensation', 'other_compensation', 'details', 'year', 'coop_year', 'coop_cycle', 'program_level', 'id']
} as const;
