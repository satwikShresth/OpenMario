...
export const UserSchema = {
    ...
    required: ['id', 'is_verified', 'username', 'password']
} as const;
...
export const ProfileMajorSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
    ...
    required: ['id', 'user_id', 'major_id']
} as const;

export const ProfileMajorInsertSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
    ...
    required: ['user_id', 'major_id']
} as const;

export const ProfileMajorUpdateSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
...
export const ProfileMinorSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
    ...
    required: ['id', 'user_id', 'minor_id']
} as const;

export const ProfileMinorInsertSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
    ...
    required: ['user_id', 'minor_id']
} as const;

export const ProfileMinorUpdateSchema = {
    type: 'object',
    properties: {
        id: {
            type: 'string',
    ...
    properties: {
        positions: {
            ...
            items: {
                ...
                required: ['company', 'position', 'location', 'work_hours', 'compensation', 'other_compensation', 'details'],
                example: {
...
export const SubmissionInsertSchema = {
    ...
    required: ['position_id', 'location_id', 'program_level', 'coop_cycle', 'coop_year', 'year']
} as const;
...
export const SubmissionResponseSchema = {
    ...
    required: ['id', 'year', 'coop_year', 'coop_cycle', 'program_level', 'work_hours', 'compensation', 'other_compensation', 'details', 'position', 'company', 'location_city', 'location_state', 'location_state_code']
} as const;
