...
import { Modal, Box, Typography, TextField, Button, IconButton, Fade, Backdrop, Alert } from '@mui/material';
      ...
      <Fade in={open}>
        <Box sx={{
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            >
              {isSubmitting || isLoading ? 'Sending Login Link...' :
                status === 'success' ? 'Magic Link Sent' :
                  'Continue with Email'}
            </Button>
          </form>
        </Box>
