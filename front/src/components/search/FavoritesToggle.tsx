  ...
  return (
    <>
      ...
      {showFavorites && hasFavorites && (
        <Configure filters={favoritesFilter} />
      )}
      ...
      <Tooltip title={tooltipTitle} arrow placement="top">
        <span>
          <Button
            ...
            sx={{
              ...
              "&:hover": {
                ...
                boxShadow: !hasFavorites ? "0 4px 0 rgba(0,0,0,0.2)" : "0 2px 0 rgba(0,0,0,0.2)",
              },
              "&:active": {
          ...
          >
            {showFavorites ? "Show All" : `Favorites Only ${hasFavorites ? `(${favorites.length})` : ""}`}
          </Button>
        </span>
      </Tooltip>
    </>
