...
import {
  InfiniteHits, InstantSearch, SearchBox, SortBy, Stats,
} from "react-instantsearch";
import {
  alpha, Box, Button, CircularProgress, Container, Divider, Drawer, Fab, Grid, IconButton, Typography, useMediaQuery, useTheme,
} from "@mui/material";
import {
  ArrowUp, Filter, X,
} from "lucide-react";
...
// Search layout component that handles common logic
