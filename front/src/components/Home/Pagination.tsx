...
const Pagination: React.FC<{ table: Table<typeof TableConfig>; query: any }> = (
  ...
  const prefetchPage = (pageIndex: number, pageSize: number) => {
    client.prefetchQuery({
      ...getSubmissionsOptions({ query: { ...query, pageIndex, pageSize } }),
      staleTime: 6000,
    });
  };
      ...
      <Box sx={{ display: "flex", alignItems: "center" }}>
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          ...
          <Button
            ...
            onMouseEnter={() =>
              canPreviousPage && prefetchPage(pageIndex - 1, pageSize)}
            disabled={!canPreviousPage}
            sx={{ minWidth: "40px", p: "4px" }}
          >
            <ChevronLeft size={18} />
          ...
          <Button
            ...
            onMouseEnter={() =>
              canNextPage && prefetchPage(pageIndex + 1, pageSize)}
          ...
          <Button
            ...
            onMouseEnter={() =>
              canNextPage &&
              prefetchPage(Math.ceil(rowCount / pageSize) - 1, pageSize)}
            disabled={!canNextPage}
            sx={{ minWidth: "40px", p: "4px" }}
          >
