...
import { Configure, Index as InstantIndex, useInstantSearch } from 'react-instantsearch'
...
function CourseSearchBody({
   ...
   return (
      <>
         <Configure query={searchQuery} hitsPerPage={12} filters={exclude} />
               ...
               {courses.map((hit: any) => (
                  ...
                  >
                     <HStack justify="space-between" align="start">
                        ...
                        <Button size="xs" colorPalette="blue" variant="subtle" onClick={() => handleAdd(hit)}>
                           <LuPlus />
                           Add
                        </Button>
                     </HStack>
   ...
   return (
      <Popover.Root open={open} onOpenChange={e => setOpen(e.open)}>
         <Popover.Trigger asChild>
            <Button size="xs" variant="ghost" disabled={disabled} w="full" justifyContent="start" color="fg.muted">
               <LuPlus />
               Add course
            </Button>
         </Popover.Trigger>
         <Portal>
            <Popover.Positioner>
               <Popover.Content minW="320px" maxW="420px" maxH="480px">
                  ...
                  <Popover.Body>
                     <InstantIndex indexName={INDEX_NAMES.courses}>
                        <CourseSearchBody
                           yearIndex={yearIndex}
                           term={term}
