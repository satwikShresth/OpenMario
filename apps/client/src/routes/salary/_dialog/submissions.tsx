...
export const Route = createFileRoute('/salary/_dialog/submissions')({
   beforeLoad: () => ({ getLabel: () => 'Submissions' }),
   component: () => {
                        ...
                        <Card.Body>
                           <VStack align='start' gap={3}>
                              <VStack align='start' gap={1}>
                                 ...
                                 <Text color='fg.muted'>{submission.position}</Text>
                              </VStack>
                              <HStack justify='space-between' width='full'>
                                 <Text fontSize='sm' color='fg.muted'>
                                    {submission.location}
                                 </Text>
                                 <Text fontSize='sm'>{submission.work_hours}h/week</Text>
                              </HStack>
                              <HStack justify='space-between' width='full'>
                                 <Text fontWeight='medium'>${submission.compensation}</Text>
