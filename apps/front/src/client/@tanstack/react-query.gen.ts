...
import { type Options, getV1PrereqByCourseId, getV1CoursesByCourseId, getV1AuthSearchToken, postV1Company, postV1Position, getV1Submissions, patchV1Submissions, postV1Submissions, getV1SubmissionsMe, getV1AutocompleteCompany, getV1AutocompletePosition, getV1AutocompleteLocation } from '../sdk.gen';
import { queryOptions, type UseMutationOptions } from '@tanstack/react-query';
import type { GetV1PrereqByCourseIdData, GetV1CoursesByCourseIdData, GetV1AuthSearchTokenData, PostV1CompanyData, PostV1CompanyError, PostV1CompanyResponse, PostV1PositionData, PostV1PositionError, PostV1PositionResponse, GetV1SubmissionsData, PatchV1SubmissionsData, PatchV1SubmissionsError, PatchV1SubmissionsResponse, PostV1SubmissionsData, PostV1SubmissionsError, PostV1SubmissionsResponse, GetV1SubmissionsMeData, GetV1AutocompleteCompanyData, GetV1AutocompletePositionData, GetV1AutocompleteLocationData } from '../types.gen';
...
export const getV1PrereqByCourseIdQueryKey = (options: Options<GetV1PrereqByCourseIdData>) => createQueryKey('getV1PrereqByCourseId', options);

/**
 * Retrieve prerequisites for a specific course
 */
export const getV1PrereqByCourseIdOptions = (options: Options<GetV1PrereqByCourseIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getV1PrereqByCourseId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getV1PrereqByCourseIdQueryKey(options)
    });
};

export const getV1CoursesByCourseIdQueryKey = (options: Options<GetV1CoursesByCourseIdData>) => createQueryKey('getV1CoursesByCourseId', options);

/**
 * Retrieve all attributes for a specific course
 */
export const getV1CoursesByCourseIdOptions = (options: Options<GetV1CoursesByCourseIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getV1CoursesByCourseId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getV1CoursesByCourseIdQueryKey(options)
    });
};
