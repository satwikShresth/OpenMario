...
export const getV1GraphPrereqByCourseIdQueryKey = (options: Options<GetV1GraphPrereqByCourseIdData>) => createQueryKey('getV1GraphPrereqByCourseId', options);

/**
 * Retrieve prerequisites for a specific course
 */
export const getV1GraphPrereqByCourseIdOptions = (options: Options<GetV1GraphPrereqByCourseIdData>) => {
    return queryOptions({
...
export const getV1GraphCoursesByCourseIdQueryKey = (options: Options<GetV1GraphCoursesByCourseIdData>) => createQueryKey('getV1GraphCoursesByCourseId', options);

/**
 * Retrieve all attributes for a specific course
 */
export const getV1GraphCoursesByCourseIdOptions = (options: Options<GetV1GraphCoursesByCourseIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getV1GraphCoursesByCourseId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getV1GraphCoursesByCourseIdQueryKey(options)
    });
};

export const getV1GraphCoursesAvailabilitiesByCourseIdQueryKey = (options: Options<GetV1GraphCoursesAvailabilitiesByCourseIdData>) => createQueryKey('getV1GraphCoursesAvailabilitiesByCourseId', options);

/**
 * Retrieve all sections available for a specific course across all terms
 */
export const getV1GraphCoursesAvailabilitiesByCourseIdOptions = (options: Options<GetV1GraphCoursesAvailabilitiesByCourseIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getV1GraphCoursesAvailabilitiesByCourseId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getV1GraphCoursesAvailabilitiesByCourseIdQueryKey(options)
    });
};
