...
export type GetV1GraphCoursesByCourseIdError =
   GetV1GraphCoursesByCourseIdErrors[keyof GetV1GraphCoursesByCourseIdErrors];
...
export type GetV1GraphCoursesByCourseIdResponse =
   GetV1GraphCoursesByCourseIdResponses[keyof GetV1GraphCoursesByCourseIdResponses];
...
export type GetV1GraphCoursesAvailabilitiesByCourseIdError =
   GetV1GraphCoursesAvailabilitiesByCourseIdErrors[
      keyof GetV1GraphCoursesAvailabilitiesByCourseIdErrors
   ];
...
export type GetV1GraphCoursesAvailabilitiesByCourseIdResponse =
   GetV1GraphCoursesAvailabilitiesByCourseIdResponses[
      keyof GetV1GraphCoursesAvailabilitiesByCourseIdResponses
   ];
...
export type GetV1SubmissionsData = {
   ...
   query: {
      ...
      program_level?: 'Undergraduate' | 'Graduate';
      sort: 'ASC' | 'DESC';
      sortField: 'company' | 'position' | 'location' | 'year' | 'coop' | 'compensation';
      pageIndex?: number;
      pageSize?: number;
      distinct: boolean;
   };
