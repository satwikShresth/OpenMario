 ...
 */
export const getV1PrereqByCourseId = <ThrowOnError extends boolean = false>(options: Options<GetV1PrereqByCourseIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetV1PrereqByCourseIdResponses, GetV1PrereqByCourseIdErrors, ThrowOnError>({
...
export const getV1CoursesByCourseId = <ThrowOnError extends boolean = false>(options: Options<GetV1CoursesByCourseIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetV1CoursesByCourseIdResponses, GetV1CoursesByCourseIdErrors, ThrowOnError>({
