 ...
 */
export const getV1CompanyPosition = <ThrowOnError extends boolean = false>(options?: Options<GetV1CompanyPositionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetV1CompanyPositionResponses, GetV1CompanyPositionErrors, ThrowOnError>({
 ...
 */
export const postV1CompanyPosition = <ThrowOnError extends boolean = false>(options?: Options<PostV1CompanyPositionData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).post<PostV1CompanyPositionResponses, PostV1CompanyPositionErrors, ThrowOnError>({
        url: '/v1/company-position',
        ...options,
        headers: {
            'Content-Type': 'application/json',
