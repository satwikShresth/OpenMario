 ...
 */
export const getV1GraphCoursesAvailabilitiesByCourseId = <ThrowOnError extends boolean = false>(options: Options<GetV1GraphCoursesAvailabilitiesByCourseIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetV1GraphCoursesAvailabilitiesByCourseIdResponses, GetV1GraphCoursesAvailabilitiesByCourseIdErrors, ThrowOnError>({
