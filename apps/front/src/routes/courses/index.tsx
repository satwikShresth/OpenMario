...
import { useQueryHook, useSearchClient } from '#/hooks';
import { ErrorComponent, LoadingComponent } from '#/components/search/Shared';
...
function SectionHit({ hit }) {
   ...
   function getRatingColor(rating, opacity = 1) {
      ...
      if (Math.abs(rating - 5.0) < 0.01) {
         return opacity < 1 ? ratingColors.gold.dark : ratingColors.gold.main;
      }
      // Scale: 1-2 (red), 2-3 (orange), 3-4 (yellow), 4-5 (green)
      if (rating >= 4) {
         return opacity < 1 ? ratingColors.excellent.dark : ratingColors.excellent.main;
      }
   ...
   function getDifficultyColor(difficulty, opacity = 1) {
      ...
      if (difficulty >= 4) {
         return opacity < 1 ? difficultyColors.hard.dark : difficultyColors.hard.main;
      }
      if (difficulty >= 3) {
         return opacity < 1 ? difficultyColors.challenging.dark : difficultyColors.challenging.main;
      }
      if (difficulty >= 2) {
         return opacity < 1 ? difficultyColors.medium.dark : difficultyColors.medium.main;
      }
                                 ...
                                 {instructor.avg_difficulty && (
                                    <Box
                                       sx={{
                                          ...
                                          alignItems: 'center',
                                          bgcolor: alpha(
                                             getDifficultyColor(instructor.avg_difficulty),
                                             0.2,
                                          ),
                                          px: 1.5,
                                          py: 0.5,
                                 ...
                                 {instructor.avg_rating && (
                                    <Box
                                       sx={{
                                          ...
                                          alignItems: 'center',
                                          bgcolor: alpha(
                                             getRatingColor(instructor.avg_rating),
                                             0.2,
                                          ),
                                          px: 1.5,
                                          py: 0.5,
