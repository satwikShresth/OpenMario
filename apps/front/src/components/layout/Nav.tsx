   ...
   return (
      <AppBar
         ...
         sx={{
            ...
            boxShadow: mode === 'light' ? 'none' : '0 0 15px rgba(0, 238, 255, 0.3)',
               ...
               >
                  <Box
                     ...
                     sx={{
                        ...
                        animation: isLogoHovered ? 'float 3s ease-in-out infinite' : 'none',
                        '@keyframes float': {
               ...
               <Tooltip title={authState ? 'Logout' : 'Login'}>
                  <IconButton
                     ...
                     sx={{
                        ...
                        '&:hover': {
                           bgcolor: authState ? profileLink.color : `${profileLink.color}22`,
                           transform: 'translateY(2px)',
                           boxShadow: mode === 'dark'
            ...
            <List sx={{ pt: 6 }}>
               {navLinks.map((link) => (
                  <ListItem
                     ...
                     sx={{
                        ...
                        boxShadow: isActive(link.path)
                           ...
                           : 'none',
                        '&:hover': {
                           bgcolor: isActive(link.path) ? link.color : `${link.color}22`,
                           transform: 'translateY(2px)',
                           boxShadow: isActive(link.path) ? '0 2px 0 rgba(0,0,0,0.6)' : 'none',
                        },
                  ...
                  >
                     <ListItemIcon
                        sx={{
                           color: isActive(link.path) ? colors.white : link.color,
                           minWidth: 40,
                        }}
                     >
                        {link.icon}
