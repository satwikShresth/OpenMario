...
export const getAuthSearchTokenOptions = (
  ...
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await MeilisearchService.getAuthSearchToken({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
...
export const getSubmissionsOptions = (
  ...
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await DefaultService.getSubmissions({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
...
export const patchSubmissionsMutation = (
  ...
  > = {
    mutationFn: async (localOptions) => {
      const { data } = await DefaultService.patchSubmissions({
        ...options,
        ...localOptions,
        throwOnError: true,
      });
...
export const postSubmissionsOptions = (
  ...
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await DefaultService.postSubmissions({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
...
export const getSubmissionsMeOptions = (
  ...
  return queryOptions({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await DefaultService.getSubmissionsMe({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
