...
ALTER TABLE "company" ADD CONSTRAINT "company_owner_id_users_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "position" ADD CONSTRAINT "position_owner_id_users_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "submission" ADD CONSTRAINT "submission_owner_id_users_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE MATERIALIZED VIEW "public"."company_omega_m_view" AS (select "company"."id", "company"."name", count("position_review"."id") as "total_reviews", count(distinct "position"."id") filter (where "position_review"."id" is not null) as "positions_reviewed", round((
      0.30 * (
   ...
   ) * 100, 1) as "work_life_score" from "company" inner join "position" on "position"."company_id" = "company"."id" left join "position_review" on "position_review"."position_id" = "position"."id" group by "company"."id", "company"."name");--> statement-breakpoint
