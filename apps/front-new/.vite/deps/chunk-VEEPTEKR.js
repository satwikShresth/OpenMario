...
var require_react_dom_development = __commonJS({
   '../../node_modules/.deno/react-dom@19.1.0/node_modules/react-dom/cjs/react-dom.development.js'(
      ...
      (function () {
         ...
         'function' === typeof Map && null != Map.prototype &&
               'function' === typeof Map.prototype.forEach && 'function' === typeof Set &&
               null != Set.prototype && 'function' === typeof Set.prototype.clear &&
               'function' === typeof Set.prototype.forEach || console.error(
               ...
               (options
                  ? (options = options.crossOrigin,
                     options = 'string' === typeof options
                        ? 'use-credentials' === options ? options : ''
                        : void 0)
                  : options = null,
         ...
         exports.preinitModule = function (href, options) {
            var encountered = '';
            'string' === typeof href && href ||
               (encountered += ' The `href` argument encountered was ' +
                  getValueDescriptorExpectingObjectForWarning(href) + '.');
            void 0 !== options && 'object' !== typeof options
               ? encountered += ' The `options` argument encountered was ' +
                  getValueDescriptorExpectingObjectForWarning(options) + '.'
               : options && 'as' in options && 'script' !== options.as &&
                  (encountered += ' The `as` option encountered was ' +
                     getValueDescriptorExpectingEnumForWarning(options.as) + '.');
            if (encountered) {
               console.error(
         ...
         exports.preload = function (href, options) {
            ...
            if (
               'string' === typeof href && 'object' === typeof options && null !== options &&
         ...
         exports.preloadModule = function (href, options) {
            ...
            void 0 !== options && 'object' !== typeof options
               ? encountered += ' The `options` argument encountered was ' +
                  getValueDescriptorExpectingObjectForWarning(options) + '.'
               : options && 'as' in options && 'string' !== typeof options.as &&
                  (encountered += ' The `as` option encountered was ' +
                     getValueDescriptorExpectingObjectForWarning(options.as) + '.');
            encountered && console.error(
...
react-dom/cjs/react-dom.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VEEPTEKR.js.map
