...
import { __toESM } from './chunk-WOOG5QLI.js';

// ../../node_modules/.deno/@tanstack+react-table@8.21.3/node_modules/@tanstack/react-table/build/lib/index.mjs
var React = __toESM(require_react(), 1);

// ../../node_modules/.deno/@tanstack+table-core@8.21.3/node_modules/@tanstack/table-core/build/lib/index.mjs
...
function getMemoOptions(tableOptions, debugLevel, key, onChange) {
   return {
      debug: () => {
         ...
         return (_tableOptions$debugAl = tableOptions == null ? void 0 : tableOptions.debugAll) !=
               null
...
function createColumn(table, columnDef, depth, parent) {
   ...
   let id =
      (_ref = (_resolvedColumnDef$id = resolvedColumnDef.id) != null
   ...
   createTable: (table) => {
      table.getHeaderGroups = memo(
         ...
         (allColumns, leafColumns, left, right) => {
            ...
            const leftColumns =
               (_left$map$filter = left == null
                     ? void 0
                     : left.map((columnId) => leafColumns.find((d) => d.id === columnId)).filter(
                        Boolean,
                     )) != null
                  ? _left$map$filter
                  : [];
            const rightColumns =
               (_right$map$filter = right == null
                     ? void 0
                     : right.map((columnId) => leafColumns.find((d) => d.id === columnId)).filter(
                        Boolean,
                     )) != null
                  ? _right$map$filter
                  : [];
      ...
      table.getLeftLeafHeaders = memo(() => [table.getLeftFlatHeaders()], (flatHeaders) => {
         return flatHeaders.filter((header) => {
            ...
            return !((_header$subHeaders2 = header.subHeaders) != null &&
      ...
      table.getRightLeafHeaders = memo(() => [table.getRightFlatHeaders()], (flatHeaders) => {
         return flatHeaders.filter((header) => {
            ...
            return !((_header$subHeaders3 = header.subHeaders) != null &&
         ...
         (left, center, right) => {
            ...
            return [
               ...(_left$0$headers = (_left$ = left[0]) == null ? void 0 : _left$.headers) != null
                  ? _left$0$headers
                  : [],
               ...(_center$0$headers = (_center$ = center[0]) == null
                     ? void 0
                     : _center$.headers) != null
                  ? _center$0$headers
                  : [],
               ...(_right$0$headers = (_right$ = right[0]) == null ? void 0 : _right$.headers) !=
                     null
                  ? _right$0$headers
                  : [],
            ].map((header) => {
...
function buildHeaderGroups(allColumns, columnsToGroup, table, headerFamily) {
   ...
   recurseHeadersForSpans(
      (_headerGroups$0$heade = (_headerGroups$ = headerGroups[0]) == null
            ? void 0
            : _headerGroups$.headers) != null
...
var ColumnFaceting = {
   createColumn: (column, table) => {
      column._getFacetedRowModel = table.options.getFacetedRowModel &&
      ...
      column._getFacetedMinMaxValues = table.options.getFacetedMinMaxValues &&
...
var includesString = (row, columnId, filterValue) => {
   ...
   const search = filterValue == null || (_filterValue$toString = filterValue.toString()) == null
      ? void 0
   ...
   createColumn: (column, table) => {
      ...
      column.getFilterFn = () => {
         ...
         return isFunction(column.columnDef.filterFn)
            ...
            : (
               // @ts-ignore
               (_table$options$filter = (_table$options$filter2 = table.options.filterFns) == null
                     ? void 0
      ...
      column.getCanFilter = () => {
         ...
         return ((_column$columnDef$ena = column.columnDef.enableColumnFilter) != null
      ...
      column.getFilterValue = () => {
         ...
         return (_table$getState$colum = table.getState().columnFilters) == null ||
               (_table$getState$colum = _table$getState$colum.find((d) => d.id === column.id)) ==
                  null
            ? void 0
      ...
      column.setFilterValue = (value) => {
         table.setColumnFilters((old) => {
            ...
            if (shouldAutoRemoveFilter(filterFn, newFilter, column)) {
               var _old$filter;
               return (_old$filter = old == null
                     ? void 0
                     : old.filter((d) => d.id !== column.id)) != null
                  ? _old$filter
                  : [];
            }
            const newFilterObj = {
   ...
   createTable: (table) => {
      ...
      table.resetColumnFilters = (defaultState) => {
         ...
         table.setColumnFilters(
            defaultState
               ? []
               : (_table$initialState$c = (_table$initialState = table.initialState) == null
                     ? void 0
...
function shouldAutoRemoveFilter(filterFn, value, column) {
   return (filterFn && filterFn.autoRemove ? filterFn.autoRemove(value, column) : false) ||
...
var ColumnGrouping = {
   ...
   createColumn: (column, table) => {
      ...
      column.getCanGroup = () => {
         ...
         return ((_column$columnDef$ena = column.columnDef.enableGrouping) != null
            ? _column$columnDef$ena
            : true) &&
   ...
   createTable: (table) => {
      ...
      table.resetGrouping = (defaultState) => {
         ...
         table.setGrouping(
            defaultState
               ? []
               : (_table$initialState$g = (_table$initialState = table.initialState) == null
                     ? void 0
   ...
   createCell: (cell, column, row, table) => {
      ...
      cell.getIsAggregated = () => {
         var _row$subRows;
         return !cell.getIsGrouped() && !cell.getIsPlaceholder() &&
...
function orderColumns(leafColumns, grouping, groupedColumnMode) {
   ...
   const groupingColumns = grouping.map((g) => leafColumns.find((col) => col.id === g)).filter(
      Boolean,
   );
...
var ColumnOrdering = {
   ...
   createColumn: (column, table) => {
      ...
      column.getIsLastColumn = (position) => {
         var _columns;
         const columns = _getVisibleLeafColumns(table, position);
         return ((_columns = columns[columns.length - 1]) == null ? void 0 : _columns.id) ===
            column.id;
      };
   },
   createTable: (table) => {
...
var ColumnPinning = {
   ...
   createColumn: (column, table) => {
      column.pin = (position) => {
         ...
         table.setColumnPinning((old) => {
            ...
            if (position === 'right') {
               ...
               return {
                  left: ((_old$left = old == null ? void 0 : old.left) != null ? _old$left : [])
                     .filter((d) => !(columnIds != null && columnIds.includes(d))),
                  right: [
                     ...((_old$right = old == null ? void 0 : old.right) != null ? _old$right : [])
                        .filter((d) => !(columnIds != null && columnIds.includes(d))),
                     ...columnIds,
                  ],
               };
            ...
            if (position === 'left') {
               ...
               return {
                  left: [
                     ...((_old$left2 = old == null ? void 0 : old.left) != null ? _old$left2 : [])
                        .filter((d) => !(columnIds != null && columnIds.includes(d))),
                     ...columnIds,
                  ],
                  right:
                     ((_old$right2 = old == null ? void 0 : old.right) != null ? _old$right2 : [])
                        .filter((d) => !(columnIds != null && columnIds.includes(d))),
               };
            }
            return {
               left: ((_old$left3 = old == null ? void 0 : old.left) != null ? _old$left3 : [])
                  .filter((d) => !(columnIds != null && columnIds.includes(d))),
               right: ((_old$right3 = old == null ? void 0 : old.right) != null ? _old$right3 : [])
                  .filter((d) => !(columnIds != null && columnIds.includes(d))),
            };
         });
      };
      column.getCanPin = () => {
         ...
         return leafColumns.some((d) => {
            ...
            return ((_d$columnDef$enablePi = d.columnDef.enablePinning) != null
               ? _d$columnDef$enablePi
               : true) &&
               ((_ref = (_table$options$enable = table.options.enableColumnPinning) != null
                     ? _table$options$enable
   ...
   createRow: (row, table) => {
      ...
      row.getLeftVisibleCells = memo(
         ...
         (allCells, left) => {
            const cells = (left != null ? left : []).map((columnId) =>
      ...
      row.getRightVisibleCells = memo(
         ...
         (allCells, right) => {
            const cells = (right != null ? right : []).map((columnId) =>
               allCells.find((cell) => cell.column.id === columnId)
            ).filter(Boolean).map((d) => ({
               ...d,
               position: 'right',
   ...
   createTable: (table) => {
      ...
      table.getIsSomeColumnsPinned = (position) => {
         ...
         return Boolean(
            (_pinningState$positio = pinningState[position]) == null
               ? void 0
      ...
      table.getLeftLeafColumns = memo(
         ...
         (allColumns, left) => {
            return (left != null ? left : []).map((columnId) =>
      ...
      table.getRightLeafColumns = memo(
         ...
         (allColumns, right) => {
            return (right != null ? right : []).map((columnId) =>
               allColumns.find((column) => column.id === columnId)
            ).filter(Boolean);
         },
...
var ColumnSizing = {
   ...
   createColumn: (column, table) => {
      ...
      column.getStart = memo(
         (
            position,
         ) => [position, _getVisibleLeafColumns(table, position), table.getState().columnSizing],
         (position, columns) =>
            columns.slice(0, column.getIndex(position)).reduce(
               (sum2, column2) => sum2 + column2.getSize(),
               0,
            ),
      ...
      column.getAfter = memo(
         ...
         (position, columns) =>
            columns.slice(column.getIndex(position) + 1).reduce(
               (sum2, column2) => sum2 + column2.getSize(),
               0,
            ),
      ...
      column.getCanResize = () => {
         var _column$columnDef$ena, _table$options$enable;
         return ((_column$columnDef$ena = column.columnDef.enableResizing) != null
            ? _column$columnDef$ena
            : true) &&
      ...
      header.getSize = () => {
         ...
         const recurse = (header2) => {
            if (header2.subHeaders.length) {
               ...
               sum2 += (_header$column$getSiz = header2.column.getSize()) != null
               ...
               table.setColumnSizingInfo((old) => {
                  ...
                  old.columnSizingStart.forEach((_ref3) => {
                     ...
                     newColumnSizing[columnId] =
                        Math.round(Math.max(headerSize + headerSize * deltaPercentage, 0) * 100) /
                        100;
                  });
                  return {
                     ...old,
...
var ColumnVisibility = {
   ...
   createColumn: (column, table) => {
      ...
      column.getCanHide = () => {
         var _column$columnDef$ena, _table$options$enable;
         return ((_column$columnDef$ena = column.columnDef.enableHiding) != null
            ? _column$columnDef$ena
            : true) &&
   ...
   createTable: (table) => {
      ...
      table.toggleAllColumnsVisible = (value) => {
         ...
         table.setColumnVisibility(
            table.getAllLeafColumns().reduce((obj, column) => ({
               ...obj,
      ...
      table.getIsAllColumnsVisible = () =>
         !table.getAllLeafColumns().some((column) =>
            !(column.getIsVisible != null && column.getIsVisible())
         );
      table.getIsSomeColumnsVisible = () =>
         table.getAllLeafColumns().some((column) =>
            column.getIsVisible == null ? void 0 : column.getIsVisible()
         );
...
var GlobalFaceting = {
   createTable: (table) => {
      table._getGlobalFacetedRowModel = table.options.getFacetedRowModel &&
      ...
      table._getGlobalFacetedMinMaxValues = table.options.getFacetedMinMaxValues &&
...
var GlobalFiltering = {
         ...
         getColumnCanGlobalFilter: (column) => {
            ...
            const value = (_table$getCoreRowMode = table.getCoreRowModel().flatRows[0]) == null ||
                  (_table$getCoreRowMode =
                        _table$getCoreRowMode._getAllCellsByColumnId()[column.id]) == null
               ? void 0
   ...
   createColumn: (column, table) => {
      column.getCanGlobalFilter = () => {
         ...
         return ((_column$columnDef$ena = column.columnDef.enableGlobalFilter) != null
            ? _column$columnDef$ena
            : true) &&
            ...
            ((_table$options$enable2 = table.options.enableFilters) != null
               ? _table$options$enable2
               : true) &&
            ((_table$options$getCol = table.options.getColumnCanGlobalFilter == null
                  ? void 0
                  : table.options.getColumnCanGlobalFilter(column)) != null
               ? _table$options$getCol
               : true) &&
            !!column.accessorFn;
      };
...
var RowExpanding = {
   ...
   createTable: (table) => {
      ...
      table._autoResetExpanded = () => {
         ...
         if (
            (_ref = (_table$options$autoRe = table.options.autoResetAll) != null
      ...
      table.resetExpanded = (defaultState) => {
         ...
         table.setExpanded(
            defaultState
               ? {}
               : (_table$initialState$e = (_table$initialState = table.initialState) == null
                     ? void 0
      ...
      table.getExpandedDepth = () => {
         let maxDepth = 0;
         const rowIds = table.getState().expanded === true
   ...
   createRow: (row, table) => {
      ...
      row.getIsExpanded = () => {
         ...
         const expanded = table.getState().expanded;
         return !!((_table$options$getIsR = table.options.getIsRowExpanded == null
               ? void 0
      ...
      row.getCanExpand = () => {
         ...
         return (_table$options$getRow = table.options.getRowCanExpand == null
               ? void 0
   ...
   createTable: (table) => {
      ...
      table.resetPageIndex = (defaultState) => {
         ...
         table.setPageIndex(
            defaultState
               ? defaultPageIndex
               : (_table$initialState$p2 = (_table$initialState = table.initialState) == null ||
      ...
      table.resetPageSize = (defaultState) => {
         ...
         table.setPageSize(
            defaultState
               ? defaultPageSize
               : (_table$initialState$p3 = (_table$initialState2 = table.initialState) == null ||
   ...
   createRow: (row, table) => {
      row.pin = (position, includeLeafRows, includeParentRows) => {
         ...
         table.setRowPinning((old) => {
            ...
            if (position === 'top') {
               ...
               return {
                  top: [
                     ...((_old$top2 = old == null ? void 0 : old.top) != null ? _old$top2 : [])
                        .filter((d) => !(rowIds != null && rowIds.has(d))),
                     ...Array.from(rowIds),
                  ],
            ...
            return {
               ...
               bottom:
                  ((_old$bottom3 = old == null ? void 0 : old.bottom) != null ? _old$bottom3 : [])
                     .filter((d) => !(rowIds != null && rowIds.has(d))),
            };
         });
      };
      ...
      row.getPinnedIndex = () => {
         ...
         const visiblePinnedRowIds =
            (_ref4 = position === 'top' ? table.getTopRows() : table.getBottomRows()) == null
               ? void 0
               : _ref4.map((_ref5) => {
                  let {
                     id,
         ...
         return (_visiblePinnedRowIds$ = visiblePinnedRowIds == null
               ? void 0
               : visiblePinnedRowIds.indexOf(row.id)) != null
      ...
      table.resetRowPinning = (defaultState) => {
         ...
         return table.setRowPinning(
            defaultState
               ...
               : (_table$initialState$r = (_table$initialState = table.initialState) == null
                     ? void 0
...
var RowSelection = {
   ...
   createTable: (table) => {
      ...
      table.getIsAllPageRowsSelected = () => {
         const paginationFlatRows = table.getPaginationRowModel().flatRows.filter((row) =>
            row.getCanSelect()
         );
         const {
            rowSelection,
      ...
      table.getIsSomePageRowsSelected = () => {
         ...
         return table.getIsAllPageRowsSelected()
            ? false
            : paginationFlatRows.filter((row) => row.getCanSelect()).some((d) =>
               d.getIsSelected() || d.getIsSomeSelected()
            );
      };
...
var mutateRowIsSelected = (selectedRowIds, id, value, includeChildren, table) => {
   ...
   if (
      includeChildren && (_row$subRows = row.subRows) != null && _row$subRows.length &&
      row.getCanSelectSubRows()
   ) {
   ...
   createColumn: (column, table) => {
      ...
      column.getSortingFn = () => {
         ...
         return isFunction(column.columnDef.sortingFn)
            ...
            ? column.getAutoSortingFn()
            : (_table$options$sortin = (_table$options$sortin2 = table.options.sortingFns) == null
                  ? void 0
      ...
      column.getFirstSortDir = () => {
         ...
         const sortDescFirst =
            (_ref = (_column$columnDef$sor = column.columnDef.sortDescFirst) != null
      ...
      column.getCanSort = () => {
         ...
         return ((_column$columnDef$ena = column.columnDef.enableSorting) != null
            ? _column$columnDef$ena
            : true) &&
      ...
      column.getCanMultiSort = () => {
         ...
         return (_ref2 = (_column$columnDef$ena2 = column.columnDef.enableMultiSort) != null
      ...
      column.getIsSorted = () => {
         ...
         const columnSort = (_table$getState$sorti = table.getState().sorting) == null
            ? void 0
      ...
      column.clearSorting = () => {
         table.setSorting((old) =>
            old != null && old.length ? old.filter((d) => d.id !== column.id) : []
         );
      };
   ...
   createTable: (table) => {
      ...
      table.resetSorting = (defaultState) => {
         ...
         table.setSorting(
            defaultState
               ? []
               : (_table$initialState$s = (_table$initialState = table.initialState) == null
                     ? void 0
...
function createTable(options) {
   ...
   table._features.forEach((feature) => {
      ...
      initialState = (_feature$getInitialSt = feature.getInitialState == null
            ? void 0
            : feature.getInitialState(initialState)) != null
   ...
   const coreInstance = {
      ...
      _getRowId: (row, index, parent) => {
         ...
         return (_table$options$getRow = table.options.getRowId == null
               ? void 0
               : table.options.getRowId(row, index, parent)) != null
            ? _table$options$getRow
      ...
      getRow: (id, searchAll) => {
         let row =
            (searchAll ? table.getPrePaginationRowModel() : table.getRowModel()).rowsById[id];
         if (!row) {
      ...
      memo(
         ...
         (expanded, rowModel, paginateExpandedRows) => {
            if (
               ...
               expanded !== true && !Object.keys(expanded != null ? expanded : {}).length
            ) {
               return rowModel;
            }
...
function getFacetedMinMaxValues() {
   return (table, columnId) =>
      memo(() => {
         ...
         return [
            (_table$getColumn = table.getColumn(columnId)) == null
               ? void 0
               : _table$getColumn.getFacetedRowModel(),
         ];
      }, (facetedRowModel) => {
         if (!facetedRowModel) return void 0;
         const uniqueValues = facetedRowModel.flatRows.flatMap((flatRow) => {
            var _flatRow$getUniqueVal;
            return (_flatRow$getUniqueVal = flatRow.getUniqueValues(columnId)) != null
               ? _flatRow$getUniqueVal
               : [];
...
function filterRowModelFromLeafs(rowsToFilter, filterRow, table) {
   ...
   const maxDepth = (_table$options$maxLea = table.options.maxLeafRowFilterDepth) != null
...
function filterRowModelFromRoot(rowsToFilter, filterRow, table) {
   ...
   const newFilteredFlatRows = [];
   const newFilteredRowsById = {};
   const maxDepth = (_table$options$maxLea2 = table.options.maxLeafRowFilterDepth) != null
            ...
            for (let j = 0; j < values.length; j++) {
               ...
               if (facetedUniqueValues.has(value)) {
                  ...
                  facetedUniqueValues.set(
                     value,
                     ((_facetedUniqueValues$ = facetedUniqueValues.get(value)) != null
                        ? _facetedUniqueValues$
                        : 0) + 1,
                  );
               } else {
         ...
         (rowModel, columnFilters, globalFilter) => {
            ...
            (columnFilters != null ? columnFilters : []).forEach((d) => {
               ...
               resolvedColumnFilters.push({
                  id: d.id,
                  filterFn,
                  resolvedValue: (_filterFn$resolveFilt = filterFn.resolveFilterValue == null
                        ? void 0
            ...
            const globallyFilterableColumns = table.getAllLeafColumns().filter((column) =>
               column.getCanGlobalFilter()
            );
            if (globalFilter && globalFilterFn && globallyFilterableColumns.length) {
               ...
               globallyFilterableColumns.forEach((column) => {
                  ...
                  resolvedGlobalFilters.push({
                     ...
                     resolvedValue:
                        (_globalFilterFn$resol = globalFilterFn.resolveFilterValue == null
                              ? void 0
               ...
               const aggregatedGroupedRows = Array.from(rowGroupsMap.entries()).map(
                  (_ref, index) => {
                     ...
                     const leafRows = depth
                        ? flattenBy(groupedRows2, (row2) => row2.subRows)
                        : groupedRows2;
                     const row = createRow(
                        table,
                        id,
                           ...
                           if (existingGrouping.includes(columnId2)) {
                              ...
                              if (groupedRows2[0]) {
                                 ...
                                 row._valuesCache[columnId2] =
                                    (_groupedRows$0$getVal = groupedRows2[0].getValue(columnId2)) !=
                                          null
            ...
            const sortData = (rows) => {
               ...
               sortedData.sort((rowA, rowB) => {
                  for (let i = 0; i < availableSorting.length; i += 1) {
                     ...
                     const isDesc =
                        (_sortEntry$desc = sortEntry == null ? void 0 : sortEntry.desc) != null
                           ? _sortEntry$desc
                           : false;
                     let sortInt = 0;
                     if (sortUndefined) {
