...
import { batch, Derived, Store } from './chunk-PKKGSRSG.js';
...
function makePathArray(str) {
   ...
   return str.replace(/(^\[)|]/gm, '').replace(/\[/g, '.').replace(reLineOfOnlyDigits, intReplace)
      .replace(reDigitsBetweenDots, `.${intReplace}.`).replace(
         reStartWithDigitThenDot,
         `${intReplace}.`,
      ).replace(reDotWithDigitsToEnd, `.${intReplace}`).replace(reMultipleDots, '.').split('.').map(
         (d) => {
...
function metaHelper(formApi) {
   function handleArrayFieldMetaShift(field, index, mode, secondIndex) {
      ...
      const handlers = {
         ...
         swap: () =>
            secondIndex !== void 0 && handleSwapMode(affectedFields, field, index, secondIndex),
         move: () =>
            secondIndex !== void 0 && handleMoveMode(affectedFields, field, index, secondIndex),
      };
      handlers[mode]();
   }
   ...
   const handleMoveMode = (fields, field, fromIndex, toIndex) => {
      ...
      Object.keys(formApi.fieldInfo).filter((fieldKey) =>
         fieldKey.startsWith(getFieldPath(field, toIndex))
      ).forEach((fieldKey) => {
...
var FormApi = class {
   ...
   constructor(opts) {
      ...
      this.mount = () => {
         ...
         (_b = (_a2 = this.options.listeners) == null ? void 0 : _a2.onMount) == null
            ? void 0
            : _b.call(_a2, { formApi: this });
      ...
      this.update = (options) => {
         ...
         const shouldUpdateReeval =
            !!((_b = (_a2 = options.transform) == null ? void 0 : _a2.deps) == null
               ? void 0
               : _b.some(
                  (val, i) => val !== this.prevTransformArray[i],
               ));
         const shouldUpdateValues = options.defaultValues &&
            !evaluate(options.defaultValues, oldOptions.defaultValues) && !this.state.isTouched;
         const shouldUpdateState = !evaluate(options.defaultState, oldOptions.defaultState) &&
         ...
         this.baseStore.setState(
            () => {
               ...
               return getDefaultFormState({
                  ...
                  values: values ?? this.options.defaultValues ??
                     ((_a2 = this.options.defaultState) == null ? void 0 : _a2.values),
                  fieldMetaBase,
               });
            },
         );
      ...
      this.validateSync = (cause) => {
         ...
         batch(() => {
            ...
            for (const validateObj of validates) {
               ...
               for (
                  ...
                  const { newErrorValue, newSource } = determineFormLevelErrorSourceAndValue({
                     ...
                     isPreviousErrorFromFormValidator: (
                        ...
                        (currentErrorMapSource == null
                           ? void 0
                           : currentErrorMapSource[errorMapKey]) === 'form'
                     ),
                     // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
                     previousErrorValue: currentErrorMap == null
                        ? void 0
                        : currentErrorMap[errorMapKey],
                  });
                  if (newSource === 'form') {
                  ...
                  if (
                     // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
                     (currentErrorMap == null ? void 0 : currentErrorMap[errorMapKey]) !==
                        newErrorValue
                  ) {
               ...
               if (
                  ((_a2 = this.state.errorMap) == null ? void 0 : _a2[errorMapKey]) !== formError
               ) {
            ...
            if (
               // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
               ((_b = this.state.errorMap) == null ? void 0 : _b[submitErrKey]) &&
               cause !== 'submit' && !hasErrored
            ) {
               this.baseStore.setState((prev) => ({
                  ...prev,
                  errorMap: {
            ...
            promises.push(
               new Promise(async (resolve) => {
                  ...
                  for (
                     ...
                     const newFormValidatorError = fieldErrorsFromFormValidators == null
                        ? void 0
      ...
      this.baseStore = new Store(
         getDefaultFormState({
            ...
            values: (opts == null ? void 0 : opts.defaultValues) ??
               ((_a = opts == null ? void 0 : opts.defaultState) == null ? void 0 : _a.values),
         }),
      );
      this.fieldMetaDerived = new Derived({
         ...
         fn: ({ prevDepVals, currDepVals, prevVal: _prevVal }) => {
            ...
            for (
               ...
               const prevBaseMeta = prevBaseStore == null
                  ? void 0
                  : prevBaseStore.fieldMetaBase[fieldName];
               ...
               if (!prevBaseMeta || currBaseMeta.errorMap !== prevBaseMeta.errorMap) {
                  ...
                  const fieldInstance = (_a2 = this.getFieldInfo(fieldName)) == null
                     ? void 0
                     : _a2.instance;
               ...
               const isDefaultValue = evaluate(
                  ...
                  curFieldVal,
                  // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
                  (_c = (_b = this.getFieldInfo(fieldName)) == null ? void 0 : _b.instance) == null
                     ? void 0
                     : _c.options.defaultValue,
               );
               if (
                  prevFieldInfo && prevFieldInfo.isPristine === isFieldPristine &&
                  prevFieldInfo.isValid === isFieldValid &&
                  prevFieldInfo.isDefaultValue === isDefaultValue &&
                  prevFieldInfo.errors === fieldErrors && currBaseMeta === prevBaseMeta
               ) {
      ...
      this.store = new Derived({
         ...
         fn: ({ prevDepVals, currDepVals, prevVal: _prevVal }) => {
            ...
            const canSubmit =
               ...
               !isValidating && !currBaseStore.isSubmitting && isValid || submitInvalid;
            ...
            if (
               prevVal && prevBaseStore && prevVal.errorMap === errorMap &&
               prevVal.fieldMeta === this.fieldMetaDerived.state && prevVal.errors === errors &&
               prevVal.isFieldsValidating === isFieldsValidating &&
               prevVal.isFieldsValid === isFieldsValid && prevVal.isFormValid === isFormValid &&
               prevVal.isValid === isValid && prevVal.canSubmit === canSubmit &&
               prevVal.isTouched === isTouched && prevVal.isBlurred === isBlurred &&
               prevVal.isPristine === isPristine && prevVal.isDefaultValue === isDefaultValue &&
               prevVal.isDirty === isDirty && evaluate(prevBaseStore, currBaseStore)
            ) {
               return prevVal;
            }
            let state = {
            ...
            const shouldTransform = transformArray.length !== this.prevTransformArray.length ||
   ...
   async handleSubmit(submitMeta) {
      ...
      batch(() => {
         void Object.values(this.fieldInfo).forEach(
            (field) => {
               var _a2, _b2, _c2;
               (_c2 =
                     (_b2 = (_a2 = field.instance) == null ? void 0 : _a2.options.listeners) == null
                        ? void 0
                        : _b2.onSubmit) == null
                  ? void 0
                  : _c2.call(_b2, {
      ...
      (_f = (_e = this.options.listeners) == null ? void 0 : _e.onSubmit) == null
         ? void 0
         : _f.call(_e, { formApi: this });
      try {
...
var FieldApi = class {
   ...
   constructor(opts) {
      ...
      this.mount = () => {
         ...
         (_b = (_a = this.options.listeners) == null ? void 0 : _a.onMount) == null
            ? void 0
            : _b.call(_a, {
               value: this.state.value,
               fieldApi: this,
      ...
      this.getLinkedFields = (cause) => {
         ...
         for (const field of fields) {
            ...
            if (
               cause === 'change' &&
               (onChangeListenTo == null ? void 0 : onChangeListenTo.includes(this.name))
            ) {
               linkedFields.push(field.instance);
            }
            if (
               cause === 'blur' &&
               (onBlurListenTo == null ? void 0 : onBlurListenTo.includes(this.name))
            ) {
               linkedFields.push(field.instance);
            }
         }
      ...
      this.validateSync = (cause, errorFromForm) => {
         ...
         batch(() => {
            const validateFieldFn = (field, validateObj) => {
               ...
               if (
                  ((_a2 = field.state.meta.errorMap) == null ? void 0 : _a2[errorMapKey]) !==
                     newErrorValue
               ) {
                  field.setMeta((prev) => ({
                     ...prev,
         ...
         if (
            // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
            ((_a = this.state.meta.errorMap) == null ? void 0 : _a[submitErrKey]) &&
            cause !== 'submit' && !hasErrored
         ) {
            this.setMeta((prev) => ({
               ...prev,
         ...
         const validateFieldAsyncFn = (field, validateObj, promises) => {
            ...
            promises.push(
               new Promise(async (resolve) => {
                  ...
                  const formLevelError = (_a = asyncFormValidationResults[this.name]) == null
                     ? void 0
                     : _a[errorMapKey];
                  const { newErrorValue, newSource } = determineFieldLevelErrorSourceAndValue({
                     formLevelError,
      ...
      this.validate = (cause, opts2) => {
         ...
         if (hasErrored && !this.options.asyncAlways) {
            (_a = this.getInfo().validationMetaMap[getErrorMapKey2(cause)]) == null
               ? void 0
               : _a.lastAbortController.abort();
            return this.state.meta.errors;
         }
         const formValidationResultPromise = (opts2 == null ? void 0 : opts2.skipFormValidation)
            ? Promise.resolve({})
   ...
   triggerOnBlurListener() {
      ...
      const formDebounceMs = (_a = this.form.options.listeners) == null
         ? void 0
         : _a.onBlurDebounceMs;
      if (formDebounceMs && formDebounceMs > 0) {
         ...
         this.timeoutIds.formListeners.blur = setTimeout(() => {
            var _a2, _b2;
            (_b2 = (_a2 = this.form.options.listeners) == null ? void 0 : _a2.onBlur) == null
               ? void 0
               : _b2.call(_a2, {
                  formApi: this.form,
                  fieldApi: this,
         ...
         (_c = (_b = this.form.options.listeners) == null ? void 0 : _b.onBlur) == null
            ? void 0
            : _c.call(_b, {
               formApi: this.form,
               fieldApi: this,
      ...
      if (fieldDebounceMs && fieldDebounceMs > 0) {
         ...
         this.timeoutIds.listeners.blur = setTimeout(() => {
            var _a2, _b2;
            (_b2 = (_a2 = this.options.listeners) == null ? void 0 : _a2.onBlur) == null
               ? void 0
               : _b2.call(_a2, {
                  value: this.state.value,
                  fieldApi: this,
         ...
         (_f = (_e = this.options.listeners) == null ? void 0 : _e.onBlur) == null
            ? void 0
            : _f.call(_e, {
               value: this.state.value,
               fieldApi: this,
   ...
   triggerOnChangeListener() {
      ...
      if (formDebounceMs && formDebounceMs > 0) {
         ...
         this.timeoutIds.formListeners.change = setTimeout(() => {
            var _a2, _b2;
            (_b2 = (_a2 = this.form.options.listeners) == null ? void 0 : _a2.onChange) == null
               ? void 0
               : _b2.call(_a2, {
                  formApi: this.form,
                  fieldApi: this,
         ...
         (_c = (_b = this.form.options.listeners) == null ? void 0 : _b.onChange) == null
            ? void 0
            : _c.call(_b, {
               formApi: this.form,
               fieldApi: this,
      ...
      const fieldDebounceMs = (_d = this.options.listeners) == null
         ? void 0
         : _d.onChangeDebounceMs;
      if (fieldDebounceMs && fieldDebounceMs > 0) {
         ...
         this.timeoutIds.listeners.change = setTimeout(() => {
            var _a2, _b2;
            (_b2 = (_a2 = this.options.listeners) == null ? void 0 : _a2.onChange) == null
               ? void 0
               : _b2.call(_a2, {
                  value: this.state.value,
                  fieldApi: this,
         ...
         (_f = (_e = this.options.listeners) == null ? void 0 : _e.onChange) == null
            ? void 0
            : _f.call(_e, {
               value: this.state.value,
               fieldApi: this,
...
function mutateMergeDeep(target, source) {
   ...
   for (const key of keySet) {
      ...
      const areObjects = isTargetObj && isSourceObj && !Array.isArray(targetValue) &&
   ...
   function useAppForm(props) {
      ...
      const AppField = (0, import_react4.useMemo)(() => {
         const AppField2 = ({ children, ...props2 }) => {
            return (0, import_jsx_runtime3.jsx)(form.Field, {
               ...props2,
               children: (field) => (
                  // eslint-disable-next-line @eslint-react/no-context-provider
                  (0, import_jsx_runtime3.jsx)(fieldContext.Provider, {
                     value: field,
