...
// ../../node_modules/.deno/next-themes@0.4.6/node_modules/next-themes/dist/index.mjs
...
var J = (e) =>
   t.useContext(x) ? t.createElement(t.Fragment, null, e.children) : t.createElement(V, { ...e });
var N = ['light', 'dark'];
var V = ({
   forcedTheme: e,
   disableTransitionOnChange: i = false,
   enableSystem: s = true,
   enableColorScheme: u = true,
   storageKey: m = 'theme',
   themes: a = N,
         ...
         let v = d ? d[r] : r,
            ...
            L = (g) => {
               g === 'class'
                  ...
                  : g.startsWith('data-') && (v ? P.setAttribute(g, v) : P.removeAttribute(g));
            };
