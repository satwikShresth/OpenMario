'use client';
import { onlineManager, useQueryClient } from './chunk-3U56OLN7.js';
import {
   createComponent,
   createSignal,
   lazy,
...
import { __privateAdd, __privateGet, __privateSet, __toESM } from './chunk-WOOG5QLI.js';

// ../../node_modules/.deno/@tanstack+react-query-devtools@5.82.0/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtools.js
var React = __toESM(require_react(), 1);

// ../../node_modules/.deno/@tanstack+query-devtools@5.81.2/node_modules/@tanstack/query-devtools/build/dev.js
var _client,
   _onlineManager,
   _queryFlavor,
   _version,
   ...
   mount(el) {
      ...
      const dispose = render(() => {
         ...
         if (__privateGet(this, _Component)) {
            ...
            Devtools = lazy(() => import('./HH7B3BHX-FQCS43DD.js'));
...
var TanstackQueryDevtoolsPanel = (_a2 = class {
   ...
   mount(el) {
      ...
      const dispose = render(() => {
         ...
         if (__privateGet(this, _Component2)) {
            ...
            Devtools = lazy(() => import('./JZI2RDCT-RQ5ACS5R.js'));
   ...
   _onlineManager2 = new WeakMap(),
   _queryFlavor2 = new WeakMap(),
   _version2 = new WeakMap(),
   _isMounted2 = new WeakMap(),
   _styleNonce2 = new WeakMap(),
   _shadowDOMTarget2 = new WeakMap(),
   _buttonPosition2 = new WeakMap(),
   _position2 = new WeakMap(),
   _initialIsOpen2 = new WeakMap(),
   _errorTypes2 = new WeakMap(),
...
// ../../node_modules/.deno/@tanstack+react-query-devtools@5.82.0/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtoolsPanel.js
...
// ../../node_modules/.deno/@tanstack+react-query-devtools@5.82.0/node_modules/@tanstack/react-query-devtools/build/modern/index.js
var ReactQueryDevtools2 = false
   ? function () {
      return null;
   }
   : ReactQueryDevtools;
var ReactQueryDevtoolsPanel2 = false
   ? function () {
      return null;
   }
