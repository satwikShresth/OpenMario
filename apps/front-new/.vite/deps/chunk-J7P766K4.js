// ../../node_modules/.deno/@tanstack+query-devtools@5.81.2/node_modules/@tanstack/query-devtools/build/chunk/V5T5VJKG.js
var sharedConfig = {
   context: void 0,
   registry: void 0,
   effects: void 0,
...
function useContext(context) {
   let value;
   return Owner && Owner.context && (value = Owner.context[context.id]) !== void 0
      ? value
...
function splitProps(props, ...keys) {
   ...
   for (const propName of Object.getOwnPropertyNames(props)) {
      ...
      const isDefaultDesc = !desc.get && !desc.set && desc.enumerable && desc.writable &&
         desc.configurable;
      let blocked = false;
      let objectIndex = 0;
      for (const k of keys) {
...
function assignProp(node, prop, value, prev, isSVG, skipRef, props) {
   ...
   if (prop === 'ref') {
      ...
      (forceProp = prop.slice(0, 5) === 'prop:') || (isChildProp = ChildProperties.has(prop)) ||
      !isSVG &&
...
function eventHandler(e) {
   ...
   const handleNode = () => {
      ...
      node.host && typeof node.host !== 'string' && !node.host._$host && node.contains(e.target) &&
         retarget(node.host);
      return true;
   };
   const walkUpTree = () => {
...
var isPrimitive = (payload) =>
   isBoolean(payload) || isNull(payload) || isUndefined(payload) || isNumber(payload) ||
   isString(payload) || isSymbol(payload);
...
var transformValue = (value, superJson) => {
   const applicableCompositeRule = findArr(
      compositeRules,
      (rule) => rule.isApplicable(value, superJson),
   );
...
var walker = (
   ...
   const transformed = (transformationResult == null ? void 0 : transformationResult.value) ??
      object;
...
var setupStyleSheet = (nonce, target) => {
   ...
   const styleExists = document.querySelector('#_goober') ||
      (target == null ? void 0 : target.querySelector('#_goober'));
...
//# sourceMappingURL=chunk-J7P766K4.js.map
