import { batch, Store } from './chunk-PKKGSRSG.js';
...
// ../../node_modules/.deno/@tanstack+history@1.121.34/node_modules/@tanstack/history/dist/esm/index.js
      ...
      block: (blocker) => {
         ...
         return () => {
            ...
            (_b = opts.setBlockers) == null
               ? void 0
               : _b.call(opts, blockers2.filter((b) => b !== blocker));
         };
      },
      flush: () => {
         var _a;
...
function createBrowserHistory(opts) {
   var _a, _b;
   const win = (opts == null ? void 0 : opts.window) ??
      (typeof document !== 'undefined' ? window : void 0);
   ...
   const parseLocation = (opts == null ? void 0 : opts.parseLocation) ?? (() =>
      parseHref(
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/utils.js
function last(arr) {
...
function replaceEqualDeep(prev, _next) {
   ...
   if (array || isSimplePlainObject(prev) && isSimplePlainObject(next)) {
      ...
      for (let i = 0; i < nextSize; i++) {
         ...
         if (
            (!array && prevItems.includes(key) || array) && prev[key] === void 0 &&
            next[key] === void 0
         ) {
            copy[key] = void 0;
            equalItems++;
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/path.js
...
function removeTrailingSlash(value, basepath) {
   if (
      (value == null ? void 0 : value.endsWith('/')) && value !== '/' && value !== `${basepath}/`
   ) {
      ...
      ...split.map((part) => {
         ...
         return {
            ...
            value: part.includes('%25')
               ? part.split('%25').map((segment) => decodeURI(segment)).join('%25')
               : decodeURI(part),
         };
      }),
   );
      ...
      for (let i = 0; i < Math.max(baseSegments.length, routeSegments.length); i++) {
         ...
         if (routeSegment) {
            ...
            if (routeSegment.type === 'pathname') {
               if (
                  routeSegment.value === '/' && !(baseSegment == null ? void 0 : baseSegment.value)
               ) {
                  return true;
               }
               if (baseSegment) {
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/not-found.js
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/qss.js
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/searchParams.js
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/root.js
var rootRouteId = '__root__';

// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/redirect.js
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/scroll-restoration.js
...
function handleHashScroll(router) {
   if (typeof document !== 'undefined' && document.querySelector) {
      const hashScrollIntoViewOptions = router.state.location.state.__hashScrollIntoViewOptions ??
         true;
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/router.js
...
function getLocationChangeInfo(routerState) {
   ...
   const pathChanged =
      (fromLocation == null ? void 0 : fromLocation.pathname) !== toLocation.pathname;
...
var RouterCore = class {
   ...
   constructor(options) {
      ...
      this.update = (newOptions) => {
         ...
         if (
            ...
            if (
               newOptions.basepath === void 0 || newOptions.basepath === '' ||
               newOptions.basepath === '/'
            ) {
               this.basepath = '/';
            } else {
         ...
         if (!this.history || this.options.history && this.options.history !== this.history) {
            this.history = this.options.history ?? (this.isServer
               ? createMemoryHistory({
         ...
         if (
            typeof window !== 'undefined' && 'CSS' in window &&
      ...
      this.buildLocation = (opts) => {
         const build = (dest = {}) => {
            ...
            const routeIsChanging = !!dest.to && !this.comparePaths(dest.to.toString(), fromPath) &&
            ...
            if (Object.keys(nextParams).length > 0) {
               destRoutes.map((route) => {
                  var _a2;
                  return ((_a2 = route.options.params) == null ? void 0 : _a2.stringify) ??
                     route.options.stringifyParams;
      ...
      this.commitLocation = ({
         ...
         if (isSameUrl && isSameState()) {
            ...
            nextHistory.state.__hashScrollIntoViewOptions = hashScrollIntoView ??
               this.options.defaultHashScrollIntoView ?? true;
                        ...
                        this.startViewTransition(async () => {
                           ...
                           [
                              ...
                              matches.forEach((match) => {
                                 var _a2, _b;
                                 (_b = (_a2 = this.looseRoutesById[match.routeId].options)[hook]) ==
                                       null
                                    ? void 0
                                    : _b.call(_a2, match);
                              });
      ...
      this.startViewTransition = (fn) => {
         const shouldViewTransition = this.shouldViewTransition ??
         ...
         if (
            ...
            if (typeof shouldViewTransition === 'object' && this.isViewTransitionTypesSupported) {
               const next = this.latestLocation;
               const prevLocation = this.state.resolvedLocation;
               const resolvedViewTransitionTypes = typeof shouldViewTransition.types === 'function'
      ...
      this.updateMatch = (id, updater) => {
         var _a;
         let updated;
         const isPending = (_a = this.state.pendingMatches) == null
            ? void 0
            : _a.find((d) => d.id === id);
               ...
               if (!allPreload && !this.isServer) {
                  matches.forEach((match) => {
                     ...
                     const pendingMinMs = route.options.pendingMinMs ??
                        this.options.defaultPendingMinMs;
                     ...
                     for (const [index, { id: matchId, routeId }] of matches.entries()) {
                        ...
                        if (this.isServer) {
                           ...
                           if ((parentMatch == null ? void 0 : parentMatch.ssr) === false) {
                              ...
                              if (
                                 tempSsr === true &&
                                 (parentMatch == null ? void 0 : parentMatch.ssr) === 'data-only'
                              ) {
                                 ssr = 'data-only';
                              } else {
                                 ssr = tempSsr;
                        ...
                        const shouldPending =
                           !!(onReady && !this.isServer && !resolvePreload(matchId) &&
                              (route.options.loader || route.options.beforeLoad ||
                                 routeNeedsPreload(route)) &&
                              typeof pendingMs === 'number' && pendingMs !== Infinity &&
                        ...
                        matchPromises.push(
                           (async () => {
                              ...
                              const executeHead = async () => {
                                 ...
                                 const headFnContent =
                                    await ((_b3 = (_a3 = route.options).head) == null
                                       ? void 0
                                 ...
                                 const styles = headFnContent == null
                                    ? void 0
                                    : headFnContent.styles;
                                 const scripts =
                                    await ((_d2 = (_c2 = route.options).scripts) == null
                                       ? void 0
                                       : _d2.call(_c2, assetContext));
                                 const headers = await ((_f = (_e = route.options).headers) == null
                                    ? void 0
                              ...
                              if (shouldSkipLoader(matchId)) {
                                 ...
                                 if (
                                    prevMatch.status === 'success' && !sync && !prevMatch.preload
                                 ) {
                                    return this.getMatch(matchId);
                                 }
                                 ...
                                 const staleAge = preload
                                    ? route.options.preloadStaleTime ??
                                       this.options.defaultPreloadStaleTime ?? 3e4
                                 ...
                                 updateMatch(matchId, (prev) => ({
                                    ...
                                    preload: !!preload && !this.state.matches.find((d) =>
                                       d.id === matchId
                                    ),
                                 }));
                                 const runLoader = async () => {
                                    ...
                                    try {
                                       try {
                                          ...
                                          const loaderData =
                                             await ((_b3 = (_a3 = route.options).loader) == null
                                                ? void 0
                                 ...
                                 loaderShouldRunAsync = status === 'success' &&
                                 ...
                                 if (preload && route.options.preload === false) {
                                    ...
                                    (async () => {
                                       try {
                                          await runLoader();
                                          const { loaderPromise, loadPromise } = this.getMatch(
                                             matchId,
                                          );
      ...
      this.invalidate = (opts) => {
         const invalidate = (d) => {
            var _a;
            if (
               ((_a = opts == null ? void 0 : opts.filter) == null ? void 0 : _a.call(opts, d)) ??
                  true
            ) {
               return {
                  ...d,
                  invalid: true,
                  ...(opts == null ? void 0 : opts.forcePending) || d.status === 'error'
      ...
      this.matchRoute = (location, opts) => {
         ...
         const pending = (opts == null ? void 0 : opts.pending) === void 0
   ...
   matchRoutesInternal(next, opts) {
      ...
      const parseErrors = matchedRoutes.map((route) => {
         ...
         const parseParams = ((_a2 = route.options.params) == null ? void 0 : _a2.parse) ??
      ...
      matchedRoutes.forEach((route, index) => {
         ...
         const loaderDeps =
            ((_b = (_a2 = route.options).loaderDeps) == null ? void 0 : _b.call(_a2, {
         ...
         if (existingMatch) {
            ...
            const status = route.options.loader || route.options.beforeLoad || route.lazyFn ||
                  routeNeedsPreload(route)
               ? 'pending'
               : 'success';
            match = {
      ...
      matches.forEach((match, index) => {
         ...
         if (!existingMatch && (opts == null ? void 0 : opts._buildLocation) !== true) {
            ...
            match.__routeContext = ((_b = (_a2 = route.options).context) == null
               ? void 0
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/defer.js
...
function defer(_promise, options) {
   ...
   promise.then((data) => {
      ...
      promise[TSR_DEFERRED_PROMISE].error = {
         data: ((options == null ? void 0 : options.serializeError) ?? defaultSerializeError)(
            error,
         ),
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/Matches.js
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/searchMiddleware.js
...
// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/link.js
var preloadWarning = 'Error preloading route! ☝️';

// ../../node_modules/.deno/@tanstack+router-core@1.125.4/node_modules/@tanstack/router-core/dist/esm/route.js
var BaseRoute = class {
   constructor(options) {
      this.init = (opts) => {
         var _a, _b;
         ...
         const isRoot = !(options2 == null ? void 0 : options2.path) &&
            !(options2 == null ? void 0 : options2.id);
         this.parentRoute = (_b = (_a = this.options).getParentRoute) == null
            ? void 0
            : _b.call(_a);
         if (isRoot) {
...
//# sourceMappingURL=chunk-VMMXHQTH.js.map
