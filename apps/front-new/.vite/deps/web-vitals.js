...
// ../../node_modules/.deno/web-vitals@4.2.4/node_modules/web-vitals/dist/web-vitals.js
var e;
var n;
var t;
var r;
...
var c = function () {
   var e3 = self.performance && performance.getEntriesByType &&
...
var f = function (e3, n2) {
   ...
   o >= 0
      ...
      : t2 && (document.prerendering || u() > 0
         ? r2 = 'prerender'
         : document.wasDiscarded
         ? r2 = 'restore'
         : t2.type && (r2 = t2.type.replace(/_/g, '-')));
   return {
      name: e3,
...
var d = function (e3, n2, t2, r2) {
   var i2, o2;
   return function (a2) {
      n2.value >= 0 && (a2 || r2) && ((o2 = n2.value - (i2 || 0)) || void 0 === i2) &&
         (i2 = n2.value,
            n2.delta = o2,
            n2.rating = function (e4, n3) {
...
var g = function (e3) {
   'hidden' === document.visibilityState && m > -1 &&
      (m = 'visibilitychange' === e3.type ? e3.timeStamp : 0, T());
};
var y = function () {
   addEventListener('visibilitychange', g, true), addEventListener('prerenderingchange', g, true);
};
var T = function () {
   removeEventListener('visibilitychange', g, true),
      removeEventListener('prerenderingchange', g, true);
};
var E = function () {
   return m < 0 && (m = h(),
      y(),
   ...
   n2 = n2 || {},
      C(function () {
         var t2,
            r2 = E(),
            i2 = f('FCP'),
            o2 = s('paint', function (e4) {
               e4.forEach(function (e5) {
                  'first-contentful-paint' === e5.name &&
                     (o2.disconnect(),
                        e5.startTime < r2.firstHiddenTime &&
                        (i2.value = Math.max(e5.startTime - u(), 0),
                           i2.entries.push(e5),
                           t2(true)));
               });
            });
         o2 && (t2 = d(e3, i2, b, n2.reportAllChanges),
            a(function (r3) {
               i2 = f('FCP'),
                  t2 = d(e3, i2, b, n2.reportAllChanges),
                  l(function () {
            ...
            c2 = function (e4) {
               e4.forEach(function (e5) {
                  if (!e5.hadRecentInput) {
                     ...
                     i2 && e5.startTime - t3.startTime < 1e3 && e5.startTime - n3.startTime < 5e3
                        ? (i2 += e5.value, o2.push(e5))
                        : (i2 = e5.value, o2 = [e5]);
                  }
               }), i2 > r2.value && (r2.value = i2, r2.entries = o2, t2());
            },
            u2 = s('layout-shift', c2);
         u2 && (t2 = d(e3, r2, L, n2.reportAllChanges),
            p(function () {
            ...
            a(function () {
               i2 = 0,
                  r2 = f('CLS', 0),
                  t2 = d(e3, r2, L, n2.reportAllChanges),
                  l(function () {
                     return t2();
                  });
            }),
...
var M = function (e3) {
   e3.forEach(function (e4) {
      e4.interactionId &&
         (I = Math.min(I, e4.interactionId),
            P = Math.max(P, e4.interactionId),
            A = P ? (P - I) / 7 + 1 : 0);
   });
};
var k = function () {
...
var F = function () {
   'interactionCount' in performance || e ||
      (e = s('event', M, { type: 'event', buffered: true, durationThreshold: 0 }));
};
var D = [];
...
var q = function (e3) {
   if (
      ...
      if (t2 || D.length < 10 || e3.duration > n2.latency) {
         if (t2) {
            e3.duration > t2.latency
               ? (t2.entries = [e3], t2.latency = e3.duration)
               : e3.duration === t2.latency && e3.startTime === t2.entries[0].startTime &&
                  t2.entries.push(e3);
         } else {
...
var j = function (e3, n2) {
   'PerformanceEventTiming' in self && 'interactionId' in PerformanceEventTiming.prototype &&
      (n2 = n2 || {},
         C(function () {
            var t2;
            F();
            var r2,
               ...
               o2 = function (e4) {
                  O(function () {
                     e4.forEach(q);
                     var n3 = B();
                     n3 && n3.latency !== i2.value &&
                        (i2.value = n3.latency, i2.entries = n3.entries, r2());
                  });
               },
               c2 = s('event', o2, {
                  durationThreshold: null !== (t2 = n2.durationThreshold) && void 0 !== t2
                     ? t2
                     : 40,
               });
            r2 = d(e3, i2, N, n2.reportAllChanges),
               c2 && (c2.observe({ type: 'first-input', buffered: true }),
                  p(function () {
   ...
   n2 = n2 || {},
      C(function () {
         var t2,
            ...
            i2 = f('LCP'),
            o2 = function (e4) {
               n2.reportAllChanges || (e4 = e4.slice(-1)),
                  e4.forEach(function (e5) {
                     e5.startTime < r2.firstHiddenTime &&
                        (i2.value = Math.max(e5.startTime - u(), 0), i2.entries = [e5], t2());
                  });
            },
...
var Q = function (e3, n2) {
   ...
   K(function () {
      var i2 = c();
      i2 &&
         (t2.value = Math.max(i2.responseStart - u(), 0),
            t2.entries = [i2],
            r2(true),
            a(function () {
...
var Y = function (e3) {
   if (e3.cancelable) {
      var n2 = (e3.timeStamp > 1e12 ? /* @__PURE__ */ new Date() : performance.now()) -
         e3.timeStamp;
      'pointerdown' == e3.type
         ? function (e4, n3) {
            var t2 = function () {
               ...
               i2 = function () {
                  removeEventListener('pointerup', t2, U),
                     removeEventListener('pointercancel', r2, U);
               };
   ...
   r2 = r2 || {},
      C(function () {
         var o2,
            ...
            u2 = f('FID'),
            l2 = function (e4) {
               e4.startTime < c2.firstHiddenTime &&
                  (u2.value = e4.processingStart - e4.startTime, u2.entries.push(e4), o2(true));
            },
            m2 = function (e4) {
               e4.forEach(l2);
            },
            h2 = s('first-input', m2);
         o2 = d(e3, u2, $, r2.reportAllChanges),
            h2 && (p(v(function () {
