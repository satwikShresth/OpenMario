...
import type {
   ...
   PostV1CompanyPositionError,
   PostV1CompanyPositionResponse,
...
export const postV1AuthLoginQueryKey = (options?: Options<PostV1AuthLoginData>) =>
   createQueryKey('postV1AuthLogin', options);
 ...
 * Request a magic link for authentication
 */
export const postV1AuthLoginMutation = (
   options?: Partial<Options<PostV1AuthLoginData>>,
): UseMutationOptions<
   PostV1AuthLoginResponse,
   PostV1AuthLoginError,
...
export const getV1AuthLoginByTokenQueryKey = (options: Options<GetV1AuthLoginByTokenData>) =>
   createQueryKey('getV1AuthLoginByToken', options);
...
export const getV1CompanyPositionQueryKey = (options?: Options<GetV1CompanyPositionData>) =>
   createQueryKey('getV1CompanyPosition', options);
...
export const postV1CompanyPositionQueryKey = (options?: Options<PostV1CompanyPositionData>) =>
   createQueryKey('postV1CompanyPosition', options);
 ...
 * Create a new company and position pair
 */
export const postV1CompanyPositionMutation = (
   options?: Partial<Options<PostV1CompanyPositionData>>,
): UseMutationOptions<
   PostV1CompanyPositionResponse,
   PostV1CompanyPositionError,
   Options<PostV1CompanyPositionData>
> => {
   const mutationOptions: UseMutationOptions<
      PostV1CompanyPositionResponse,
      PostV1CompanyPositionError,
