...
// const query = `
//         MATCH path = (subject:Subject {id: $subjectId})<-[:\`Part of\`]-(course:Course {course_number: $courseNumber})-[:PREREQUISITE]->(prereq)
//         RETURN path, subject, course, prereq
//     `;
// const params = {
//   subjectId: "CS",
//   courseNumber: "360",
// };
//
// console.log(await neo4jService.executeReadQuery(query, params));
