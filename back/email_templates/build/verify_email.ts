  ...
  html`<!doctype html>
    ...
    >
      ...
      <body style="word-spacing:normal;background-color:#fafbfc;">
        <div style="background-color:#fafbfc;" lang="und" dir="auto">
          ...
          >
            ...
            >
              <tbody>
                <tr>
                  <td
                    style="direction:ltr;font-size:0px;padding:40px 20px;text-align:center;"
                  >
                      ...
                      >
                        <tbody>
                                ...
                                <tbody>
                                  <tr>
                                    <td
                                      ...
                                      bgcolor="#2196F3"
                                      role="presentation"
                                      style="border:none;border-radius:8px;cursor:auto;mso-padding-alt:10px 25px;background:#2196F3;"
                                      valign="middle"
                                    >
                                      <a
                                        href="${magic_link}"
                                        style="display:inline-block;background:#2196F3;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:8px;"
                                        target="_blank"
                                      >
                          ...
                          <tr>
                            ...
                            >
                              <div
                                style="font-family:Arial, Helvetica, sans-serif;font-size:14px;line-height:1;text-align:center;color:#777777;"
                              >
                    ...
                    >
                      ...
                      >
                        <tbody>
                          <tr>
                            <td
                              style="background-color:#f5f5f5;border:1px dashed #ccc;border-radius:4px;vertical-align:top;padding:10px;"
                            >
                              <table
                                border="0"
                                cellpadding="0"
                              ...
                              >
                                <tbody>
                                  <tr>
                                    ...
                                    >
                                      <div
                                        style="font-family:monospace;font-size:12px;line-height:1;text-align:center;color:#333333;"
                                      >
                                        ${magic_link}
                                      </div>
                                    </td>
                      ...
                      >
                        <tbody>
                          <tr>
                            ...
                            >
                              <div
                                style="font-family:Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;line-height:1;text-align:center;color:#555555;"
                              >
                                Copy Magic Link:
                              </div>
                            </td>
                          ...
                          <div style="text-align: center; padding: 10px;">
                            <div
                              style="display: inline-flex; max-width: 100%; margin: 0 auto;"
                            >
                              <input
                                type="text"
                                value="${magic_link}"
                            ...
                            <div
                              id="copyMessage"
                              style="color: #4CAF50; font-size: 12px; margin-top: 5px; display: none;"
                            >
                              Copied to clipboard!
                            </div>
                            <script>
                              function copyMagicLink() {
                                var copyText =
                                  document.getElementById("magicLinkInput");
                                copyText.select();
                          ...
                          <tr>
                            ...
                            >
                              <div
                                style="font-family:Arial, Helvetica, sans-serif;font-size:12px;line-height:1;text-align:center;color:#777777;"
                              >
          ...
          >
            ...
            >
              <tbody>
                <tr>
                  <td
                    style="direction:ltr;font-size:0px;padding:0 20px 40px 20px;text-align:center;"
                  >
                    <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:middle;width:560px;" ><![endif]-->
                    <div
                      class="mj-column-per-100 mj-outlook-group-fix"
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            >
                              ...
                              <!--[if mso | IE
                                  ...
                                  cellpadding="0"
                                  cellspacing="0"
                                  style="border-top:solid 2px #cccccc;font-size:1px;margin:0px auto;width:510px;"
                                  role="presentation"
                                  width="510px"
                                >
                                  <tr>
                          ...
                          <tr>
                            ...
                            >
                              ...
                              >
                                If you didn't request this login link, please
                                ignore this email.
                              </div>
                            </td>
                          </tr>
