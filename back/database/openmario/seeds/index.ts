...
async function seedJobDatabase() {
  try {
    ...
    // Step 5: Only start search engine after job postings are fully resolved
    console.log("Starting search engine seeding...");
    await seedSearchEngine();
    console.log("Search engine seeding completed.");
