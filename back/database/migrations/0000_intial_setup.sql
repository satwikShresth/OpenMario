...
ALTER TABLE "submission" ADD CONSTRAINT "submission_owner_id_users_id_fk" FOREIGN KEY ("owner_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;